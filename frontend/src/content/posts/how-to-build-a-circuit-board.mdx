(Originally published to the Painless Prototyping Blog (now deactivated))
...
<Figure
  src="/post-resources/how-to-build-a-circuit-board/pcb1.jpg"
  caption="Breadboarding my Arduino Camera"
/>
...
<Figure
  src="/post-resources/how-to-build-a-circuit-board/pcb2.png"
  caption="CAD Model"
/>
...
<Figure
  src="/post-resources/how-to-build-a-circuit-board/pcb3.jpg"
