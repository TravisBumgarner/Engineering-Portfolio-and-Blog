...
<p><Weak>([Originally published on the DEPT® Engineering Blog](https://engineering.deptagency.com/software-engineers-rush-to-write-bad-code))</Weak></p>
