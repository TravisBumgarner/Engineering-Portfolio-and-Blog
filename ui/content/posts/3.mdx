...
<Figure src="combining-hobbies/arducam.jpg" caption="Arducam" />
...
<Figure src="combining-hobbies/example.png" caption="Example Output" />
...
<Figure src="combining-hobbies/finalImage0-1.png" caption="Sample Output" />
...
<Figure src="combining-hobbies/arducam3-1-1.jpg" caption="Saturday Night Soldering" />

<Figure src="combining-hobbies/arducam3-1-2.jpg" caption="Sunday Morning Soldering" />

<Figure src="combining-hobbies/arducam3-1-3.jpg" caption="Finished Bottom Shot" />

<Figure src="combining-hobbies/arducam3-1-4.jpg" caption="Finished Top Shot" />
...
<Figure src="combining-hobbies/arducam3-1-5.jpg" caption="Finished Project!" />
