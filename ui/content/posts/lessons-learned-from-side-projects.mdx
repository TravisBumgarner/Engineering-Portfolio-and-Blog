...
<Figure caption="Spent hours failing to debug this camera, asked for help and the issue was resolved immediately." src="/post-resources/lessons-learned-from-side-projects/ask-for-help.jpg" />
...
<Figure caption="Slipped up and monetized my photography." src="/post-resources/lessons-learned-from-side-projects/capitalism.png" />
...
<Figure caption="Got stuck on the last tasks for my first game and almost gave up." src="/post-resources/lessons-learned-from-side-projects/pausing.png" />
...
<Figure caption="The moment just before burnout." src="/post-resources/lessons-learned-from-side-projects/know-why.jpg" />
