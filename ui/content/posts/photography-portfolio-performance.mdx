...
- [Chrome Lighthouse](https://developer.chrome.com/docs/lighthouse/overview) - Analyze your website and learn about opportunities to improve performance. This is a solid starting point and where a lot of my learnings originated from.
